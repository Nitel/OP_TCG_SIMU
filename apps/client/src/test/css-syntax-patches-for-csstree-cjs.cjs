// ../../node_modules/.pnpm/@csstools+css-syntax-patches-for-csstree@1.1.4_css-tree@3.2.1/node_modules/@csstools/css-syntax-patches-for-csstree/dist/index.json
var next = {
  atrules: {
    "color-profile": {
      descriptors: {
  ...
  properties: {
    ...
    "alignment-baseline": "auto | before-edge | text-before-edge | after-edge | text-after-edge | baseline | <baseline-metric>",
    all: " | revert-rule",
    ...
    "column-gap": "normal | <length-percentage [0,\u221E]> | <line-width>",
    ...
    "row-gap": "normal | <length-percentage [0,\u221E]> | <line-width>",
    ...
    "white-space": "normal | pre | pre-wrap | pre-line | [ <'white-space-collapse'> || <'text-wrap'> || <'white-space-trim'> ]",
  ...
  types: {
    ...
    "url-set": "image-set( <url-set-option># )",
